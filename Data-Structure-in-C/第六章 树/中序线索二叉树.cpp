...
bithptr *root,*Q[maxsize],*pre=NULL;       //队列Q为bitree指针类型的数组//全程量pre，初值应为NULL
...
//中序遍历二叉树
void TRAVERSEINTHREAD1(bithptr *p)
{
	if(p!=NULL)
	{
		while(p->rtag==0)
...
void menu()
{
	...
	cout<<"   1、输入二叉树"<<endl;
	cout<<"   2、二叉树线索化"<<endl;
	cout<<"   3、中序遍历二叉树（找后继）"<<endl;
    cout<<"   4、中序遍历二叉树（找前趋）"<<endl;
	cout<<"   0、退出"<<endl;
	cout<<"*****************************"<<endl;
	cout<<"请输入功能选项号0~4：";
}
void main()
{
    ...
    while(1)
	{
        ...
        case 4:TRAVERSEINTHREAD1(root);cout<<"全部顺序颠倒即是中序遍历顺序"<<endl;flushall();getchar();break;
	    case 0:cout<<"退出";
		       exit(0);
		}
	}
